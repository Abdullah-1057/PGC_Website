              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-brand-muted-600">
                    <li>• Fees can be paid in 4 installments</li>
                    <li>• First installment includes admission fee (half)</li>
                    <li>• Remaining installments are tuition and miscellaneous fees</li>
