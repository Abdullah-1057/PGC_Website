...
const navigation = {
  ...
  courses: [
    ...
    { name: 'BS', href: '/courses' },
    { name: 'ADP', href: '/courses' },
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-6">
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-12 h-12 bg-white/10 hover:bg-black rounded-full transition-all duration-300 group"
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                >
